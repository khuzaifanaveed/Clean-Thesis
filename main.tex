...
\newcommand{\thesisDateSubmission}{May 31, 2025}
...
\renewcommand{\cftfigfont}{\helv\small}

\renewcommand{\cftlottitlefont}{\thesischapterfont\huge\bfseries}
\renewcommand{\cfttabfont}{\helv\small}
...
\input{content/abstract}		% INCLUDE: the abstracts
\cleardoublepage
...
\input{content/DarkSirenCosmology}
\input{content/Gwcosmo}
\input{content/Data}
\input{content/Methodology}
%\input{content/Results}
\input{content/MockDataChallenge}
